  ...
  return (
    <Container>
      <Wrapper>
        ...
        <Desc>Sinta-se à vontade para entrar em contato comigo para qualquer dúvida ou oportunidade!</Desc>
        <ContactForm ref={form} onSubmit={handleSubmit}>
          ...
          <ContactInputMessage placeholder="Menssagem" rows="4" name="message" />
